...
<div class="uh-nav mb-10 mb-tabar" style="clear:both">
    ...
    <div class="item tl">
      <a href="<?php echo U('Book/record');?>" class="link">
        ...
        <div class="text">
          <svg xmlns="http://www.w3.org/2000/svg" width="8" height="14" viewBox="0 0 14 24"><title>right-arrow</title><path d="M1.91 1.93L12.06 12 1.91 22" fill="none" stroke="#888888" stroke-linecap="round" stroke-linejoin="round" stroke-width="2"/></svg>
        </div>
      </a>
    </div>
