...
<title><?php echo ($_CFG['site']['name']); ?> - 登录</title>
...
<div id="app">
	<div class="login">
		...
		<div class="login-reg-button">
			<a href="./index.php?m=&c=MhPublic&a=register" class="">没有账号？去注册</a>
		</div>
	</div>
</div>
...
<script>
	...
	function login() {
		...
		var url1 = '<?php echo U("MhPublic/binding");?>';
	    var data1 = {mobile:mobile,pass:pass,fr:fr};
