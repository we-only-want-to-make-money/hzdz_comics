...
<head>
    ...
    <script>(function(){new Image().src='//res.efucms.com/wap_v3/images/placeholder-unruly.png?v=20171208';new Image().src='//res.efucms.com/wap_v3/images/placeholder-cover.png?v=20171208';})();</script>
    <style type="text/css">
		...
		<div class="books-row">
			<?php if(is_array($v['list'])): $i = 0; $__LIST__ = $v['list'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><div class="item">
				<a href="<?php echo U('bookinfo');?>&yid=<?php echo ($vo["id"]); ?>">
					<img class="lazy" src="<?php echo ($vo["cover_pic"]); ?>" data-original="<?php echo ($vo["cover_pic"]); ?>" style="width:110px;height:110px;" />
