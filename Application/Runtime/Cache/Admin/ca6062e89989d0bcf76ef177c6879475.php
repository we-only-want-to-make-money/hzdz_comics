...
<div class="bodywrapper">
    ...
    <div class="centercontent">
        ...
        <div class="pageheader notab">
            <h1 class="pagetitle">漫画分集图片内容设置（<?php echo ($mhinfo["title"]); ?>）（第<?php echo ($episodesinfo["ji_no"]); ?>话  <?php echo ($episodesinfo["title"]); ?>）</h1>
            <span class="pagedesc">设置漫画图片链接地址，回车进行隔开</span>
        ...
        <div id="contentwrapper" class="contentwrapper lineheight21">
            <form class="stdform stdform2" method="post">
				...
				<table class="form-table" cellspacing="1" border="0">
					<tr>
						<th class="title">第三方图片链接<small>多个图片已回车进行隔开</small></th>
						<td>
							<textarea name="body" id="body" class="longinput" style="margin: 0px; height: 500px; max-width:960px;"><?php echo ($arrpics); ?></textarea>
						</td>
					</tr>
				</table>
				<p class="stdformbutton">
					<input type="hidden"  name="mhid" value="<?php echo ($_GET['mhid']); ?>" />
