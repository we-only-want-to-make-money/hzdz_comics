...
<div class="bodywrapper">
    ...
    <div class="centercontent">
        ...
        <div class="pageheader notab">
            <h1 class="pagetitle">编辑客服消息</h1>
            <span class="pagedesc">添加客服消息之后记得添加文章!</span>
        ...
        <div id="contentwrapper" class="contentwrapper lineheight21">
            ...
            <form class="stdform stdform2" method="post">
				<p>
					<label>客服消息标题<small></small></label>
					<span class="field"><input type="text" name="title" id="title" value="<?php echo ($info["title"]); ?>" class="smallinput" /></span>
				</p>
