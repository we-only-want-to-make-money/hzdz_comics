        ...
        <div id="contentwrapper" class="contentwrapper lineheight21">
            ...
            <form class="stdform stdform2" method="post">
				...
				<p>
					...
					<span class="field">
						<select name="paymodel" default="<?php echo ($_CFG['site']['paymodel']); ?>">
							...
							<option value="2">优云宝收款</option>
							<option value="3">个人微信收款</option>
						</select>
					</span>
				</p>
				<p>
				...
				<p>
					...
					<span class="field"><input type="text" name="smsuser" id="smsuser" value="<?php echo ($_CFG["site"]["smsuser"]); ?>" class="smallinput" /></span>
				</p>
				<p>
...
<p>
				...
				<p>
					<label>平台二维码</label>
					<span class="field">
						<iframe src="<?php echo U('upload', 'event=setPic&url='.$_CFG['site']['qrcode']);?>" scrolling="no" width="100" height="100"></iframe>
