...
<div class="bodywrapper">
    ...
    <div class="centercontent">
        ...
        <div class="pageheader notab">
            <h1 class="pagetitle">举报中心</h1>
            <span class="pagedesc">管理用户的举报信息</span>
        ...
        <div id="contentwrapper" class="contentwrapper lineheight21" style="background:#fff">
			<table cellpadding="0" cellspacing="0" border="0" id="table2" class="stdtable stdtablecb">
				<thead>
					<tr>
						<th class="head1">被举报漫画/小说</th>
						<th class="head1">类型</th>
						<?php if(is_array($jub)): foreach($jub as $key=>$v): ?><th class="head1"><?php echo ($v); ?>被举报次数</th><?php endforeach; endif; ?>
						<th class="head1">总举报次数</th>
				...
				<tbody>
					<?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
						...
						<td>
							<?php if($vo['type'] == 'xs'): ?>小说
							<?php else: ?>
								漫画<?php endif; ?>
						</td>
						<?php if(is_array($jub)): foreach($jub as $k=>$v): ?><td><?php echo ($vo[$k]); ?></td><?php endforeach; endif; ?>
