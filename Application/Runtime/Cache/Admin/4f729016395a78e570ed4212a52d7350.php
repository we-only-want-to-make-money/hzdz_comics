...
<div class="bodywrapper">
    ...
    <div class="centercontent">
        ...
        <div class="pageheader notab">
            <h1 class="pagetitle">打赏赠送设置</h1>
            <span class="pagedesc">前端用户对喜爱的漫画或小说进行打赏的相关设置，包括打赏赠送的礼物图案以及对应的书币量。</span>
        </div><!--pageheader-->
        ...
        <div id="contentwrapper" class="contentwrapper lineheight21">
            ...
            <form class="stdform stdform2" method="post">
				...
				<table cellpadding="0" cellspacing="0" border="0" id="table2" class="stdtable stdtablecb">
                    <thead>
                        <tr>
                            <th class="head1" width="120">图片</th>
							<th class="head1">打赏书币</th>
							<th class="head1">操作</th>
                        </tr>
                    </thead>
                    <tbody>
						
                    	<?php if(is_array($_send)): $i = 0; $__LIST__ = $_send;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr style="background:#fff">
                            <td>
