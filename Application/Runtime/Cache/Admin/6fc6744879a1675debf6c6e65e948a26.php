...
<div class="bodywrapper">
    ...
    <div class="centercontent">
        ...
        <div class="pageheader notab">
            <h1 class="pagetitle">漫画首页轮播图设置</h1>
            <span class="pagedesc">设置漫画首页顶部轮播的图片和链接,最多支持8张图片</span>
            ...
            <form class="stdform stdform2" method="post">
				...
				<table cellpadding="0" cellspacing="0" border="0" id="table2" class="stdtable stdtablecb">
                    ...
                    <tbody>
                    	...
                    	<?php if(is_array($_CFG['banner']['config'])): $i = 0; $__LIST__ = $_CFG['banner']['config'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr style="background:#fff">
                            <td>
								<iframe src="<?php echo U('upload?event=setPath'.$i.'&url='.$vo['pic']);?>" scrolling="no" style="width:400px; height:275px;"></iframe>
				...
				function add_row(){
					...
					html = '<tr style="background:#fff">'
						  +'	 <td>'
						  +'		<iframe src="<?php echo U('upload?event=setPath_n_');?>" scrolling="no" style="width:400px; height:275px;"></iframe>'
