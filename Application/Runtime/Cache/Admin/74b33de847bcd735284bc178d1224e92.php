			...
			<table cellpadding="0" cellspacing="0" border="0" id="table2" class="stdtable stdtablecb">
				<thead>
					<tr>
						...
						<th class="head1">支付宝名称</th>
						<th class="head1">支付宝账号</th>
				...
				<tbody>
					<?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr style="background:#fff">
						...
						<td class="center">
							...
							<!--企业付款方式显示一件转账链接-->
							<?php if($_CFG['site']['withdraw'] == 2): ?><a href="<?php echo U('Finance/pay', array('user_id' => $vo['user_id'],'money' => $vo['money'], 'remark' => '平台提现'));?>" target="_blank">一键转账</a>	 |<?php endif; ?>
