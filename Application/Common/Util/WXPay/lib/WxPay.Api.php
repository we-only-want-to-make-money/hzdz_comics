...
class WxPayApi
{
	 ...
	 * @return 成功时返回，其他抛异常
	 */
	public static function unifiedOrder($inputObj, $exconfig, $timeOut = 6)
	{	
		...
		if(!$inputObj->IsNotify_urlSet()){
			$inputObj->SetNotify_url($exconfig['notify_url']);//异步通知url
		}
		
		$inputObj->SetAppid($exconfig['appid']);//公众账号ID
		$inputObj->SetMch_id($exconfig['mch_id']);//商户号
